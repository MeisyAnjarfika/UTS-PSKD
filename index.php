	...
	<div class="wrapper">
		...
		<header class="main-header">
			<a href="index2.html" class="logo">
			  ...
			  <span class="logo-lg"><b>Welcome</b>Back</span>
			</a>
		...
		<div class="content-wrapper">
			...
			<center><b> Vignere Chiper</b><center><hr> 
				<tr>
					<td align="center">Key: <input type="text" name="key" id="pass" value="<?php echo htmlspecialchars($key); ?>" /></td>
				</tr>
				<tr>
					<td align="center"><textarea id="box" rows="5" cols="80" name="code"><?php echo htmlspecialchars($code); ?></textarea></td>
				</tr>
				<tr>
